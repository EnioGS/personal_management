...
function entry(overrides: Partial<FilteredEntry> = {}): FilteredEntry {
  return { tableId: 1, date: Date.UTC(2026, 7, 30), amount: 100, direction: 'out', category: 'Food', description: 'Market', financeDestination: 'spending', flowRole: 'outflow', ...overrides }
}
