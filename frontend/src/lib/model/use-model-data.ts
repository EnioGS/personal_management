...
import type { Entry, TableKind } from './types'
 ...
 */
export function useActiveTableEntries(workspaceId: string, kinds: TableKind[]): StoredRow<Entry>[] {
